...
abbrev/form[@lang='en']/text
    -->
    <xsl:variable name="vPOSRangeList" select="document('LIFT.lift-ranges')/lift-ranges/range[@id='grammatical-info']"/>
    <!--<xsl:key name="kFVPOS" match="range-element" use="@id"/>-->
